...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.surf.set_colorkey((202, 229, 238))
...
pygame.mixer.music.load("./samolet_fly.mp3")
pygame.mixer.music.play(loops=-1)

# Load all sound files
# Sound sources: Jon Fincher
move_up_sound = pygame.mixer.Sound("./samolet_up.mp3")
move_down_sound = pygame.mixer.Sound("./samolet_down.mp3")
collision_sound = pygame.mixer.Sound("./sbili.mp3")
